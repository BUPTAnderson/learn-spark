...
/**
  ...
  * 启动脚本:
  ...
  /home/anderson/GitHub/spark-2.2.0-bin-hadoop2.6/bin/spark-submit \
    ...
    --class org.training.spark.sql.JDBCOperation \
    --master yarn \
    --deploy-mode client \
...
object JDBCOperation {
  def main(args: Array[String]): Unit = {
    ...
    val spark = SparkSession
      .builder()
      .config(conf)
      .config("spark.driver.extraClassPath", "/home/anderson/.m2/repository/mysql/mysql-connector-java/5.1.38/mysql-connector-java-5.1.38.jar")
      .config("spark.executor.extraClassPath", "/home/anderson/.m2/repository/mysql/mysql-connector-java/5.1.38/mysql-connector-java-5.1.38.jar")
      .getOrCreate()
